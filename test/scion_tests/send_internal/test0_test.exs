...
# scion/send-internal/test0, by tools/corpus/scion/cases.exs. Regenerate with
# `mise run corpus:emit`; never edit by hand.
#
# The document in this test is test/send-internal/test0.scxml from the SCION
