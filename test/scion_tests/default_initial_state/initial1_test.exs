...
# scion/default-initial-state/initial1, by tools/corpus/scion/cases.exs.
# Regenerate with `mise run corpus:emit`; never edit by hand.
#
# The document in this test is test/default-initial-state/initial1.scxml from
...
defmodule SCIONTest.DefaultInitialState.Initial1Test do
  ...
  @tag spec: "default-initial-state"
  test "initial1" do
    xml = """
