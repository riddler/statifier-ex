...
# scion/hierarchy+documentOrder/test0, by tools/corpus/scion/cases.exs.
# Regenerate with `mise run corpus:emit`; never edit by hand.
#
# The document in this test is test/hierarchy+documentOrder/test0.scxml from
...
defmodule SCIONTest.HierarchyDocumentOrder.Test0Test do
  ...
  @tag spec: "hierarchy+documentOrder"
  test "test0" do
    xml = """
