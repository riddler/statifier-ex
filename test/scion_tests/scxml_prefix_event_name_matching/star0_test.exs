...
# scion/scxml-prefix-event-name-matching/star0, by
# tools/corpus/scion/cases.exs. Regenerate with `mise run corpus:emit`; never
# edit by hand.
#
# The document in this test is
# test/scxml-prefix-event-name-matching/star0.scxml from the SCION
...
defmodule SCIONTest.ScxmlPrefixEventNameMatching.Star0Test do
  ...
  @moduletag :scion
  @tag required_features: [:basic_states, :compound_states, :event_transitions, :wildcard_events]
  @tag spec: "scxml-prefix-event-name-matching"
  test "star0" do
    xml = """
