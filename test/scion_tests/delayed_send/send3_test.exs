# Generated from conformance/corpus/scion.json, case scion/delayedSend/send3,
# by tools/corpus/scion/cases.exs. Regenerate with `mise run corpus:emit`;
# never edit by hand.
#
# The document in this test is test/delayedSend/send3.scxml from the SCION
