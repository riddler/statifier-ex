...
# scion/more-parallel/test2b, by tools/corpus/scion/cases.exs. Regenerate with
# `mise run corpus:emit`; never edit by hand.
#
# The document in this test is test/more-parallel/test2b.scxml from the SCION
