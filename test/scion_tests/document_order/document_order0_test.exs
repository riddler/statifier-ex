...
# scion/documentOrder/documentOrder0, by tools/corpus/scion/cases.exs.
# Regenerate with `mise run corpus:emit`; never edit by hand.
#
# The document in this test is test/documentOrder/documentOrder0.scxml from
