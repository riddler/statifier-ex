...
# scion/targetless-transition/test3, by tools/corpus/scion/cases.exs.
# Regenerate with `mise run corpus:emit`; never edit by hand.
#
# The document in this test is test/targetless-transition/test3.scxml from the
...
defmodule SCIONTest.TargetlessTransition.Test3Test do
  ...
  @tag spec: "targetless-transition"
  test "test3" do
    xml = """
