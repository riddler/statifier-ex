...
# scion/multiple-events-per-transition/test1, by tools/corpus/scion/cases.exs.
# Regenerate with `mise run corpus:emit`; never edit by hand.
#
# The document in this test is test/multiple-events-per-transition/test1.scxml
# from the SCION scxml-test-framework
...
defmodule SCIONTest.MultipleEventsPerTransition.Test1Test do
  ...
  @tag spec: "multiple-events-per-transition"
  test "test1" do
    xml = """
