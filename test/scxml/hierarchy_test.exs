defmodule HierarchyTest do
  ...
  test "scxml test hier1" do
    scxml_path = "./test/fixtures/scxml/hierarchy/hier1.scxml"
    test_path = "./test/fixtures/scxml/hierarchy/hier1.json"
    {:ok, test_contents} = File.read Path.expand test_path
    {:ok, test_config} = Poison.decode test_contents
  ...
  test "scxml test hier2" do
    scxml_path = "./test/fixtures/scxml/hierarchy/hier2.scxml"
    test_path = "./test/fixtures/scxml/hierarchy/hier2.json"
    {:ok, test_contents} = File.read Path.expand test_path
    {:ok, test_config} = Poison.decode test_contents
