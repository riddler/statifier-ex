# Generated from conformance/corpus/w3c.json, case w3c/test388, by
# tools/corpus/scxml_w3/cases.exs. Regenerate with `mise run corpus:emit`;
# never edit by hand.
#
# The document in this test is transformed for the predicator datamodel from
# 388/test388.txml of the W3C SCXML Implementation Report Plan test suite
...
defmodule SCXMLTest.History.Test388 do
  ...
  test "test388" do
    ...
    <scxml xmlns="http://www.w3.org/2005/07/scxml" version="1.0" initial="s012" datamodel="predicator">
        <datamodel>
            <data id="Var1" expr="0" />
        </datamodel>
