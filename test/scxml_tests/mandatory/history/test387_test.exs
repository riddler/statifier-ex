# Generated from conformance/corpus/w3c.json, case w3c/test387, by
# tools/corpus/scxml_w3/cases.exs. Regenerate with `mise run corpus:emit`;
# never edit by hand.
#
# The document in this test is transformed for the predicator datamodel from
# 387/test387.txml of the W3C SCXML Implementation Report Plan test suite
...
defmodule SCXMLTest.History.Test387 do
  ...
  test "test387" do
    ...
    <scxml xmlns="http://www.w3.org/2005/07/scxml" initial="s3" version="1.0" datamodel="predicator">
