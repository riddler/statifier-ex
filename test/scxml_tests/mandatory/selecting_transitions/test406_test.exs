# Generated from conformance/corpus/w3c.json, case w3c/test406, by
# tools/corpus/scxml_w3/cases.exs. Regenerate with `mise run corpus:emit`;
# never edit by hand.
#
# The document in this test is transformed for the predicator datamodel from
# 406/test406.txml of the W3C SCXML Implementation Report Plan test suite
...
defmodule SCXMLTest.SelectingTransitions.Test406 do
  ...
  test "test406" do
    ...
    <scxml xmlns="http://www.w3.org/2005/07/scxml" version="1.0" initial="s0" datamodel="predicator">
