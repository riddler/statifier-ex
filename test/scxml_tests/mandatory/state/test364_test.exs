# Generated from conformance/corpus/w3c.json, case w3c/test364, by
# tools/corpus/scxml_w3/cases.exs. Regenerate with `mise run corpus:emit`;
# never edit by hand.
#
# The document in this test is transformed for the predicator datamodel from
# 364/test364.txml of the W3C SCXML Implementation Report Plan test suite
...
defmodule SCXMLTest.State.Test364 do
  ...
  test "test364" do
    ...
    <scxml xmlns="http://www.w3.org/2005/07/scxml" datamodel="predicator" initial="s1" version="1.0">
