# Generated from conformance/corpus/w3c.json, case w3c/test280, by
# tools/corpus/scxml_w3/cases.exs. Regenerate with `mise run corpus:emit`;
# never edit by hand.
#
# The document in this test is transformed for the predicator datamodel from
# 280/test280.txml of the W3C SCXML Implementation Report Plan test suite
...
defmodule SCXMLTest.Data.Test280 do
  ...
  test "test280" do
    ...
    <scxml xmlns="http://www.w3.org/2005/07/scxml" initial="s0" version="1.0" datamodel="predicator" binding="late">
        <datamodel>
            <data id="Var1" />
        </datamodel>
        <state id="s0">
