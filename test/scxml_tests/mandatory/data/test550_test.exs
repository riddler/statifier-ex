# Generated from conformance/corpus/w3c.json, case w3c/test550, by
# tools/corpus/scxml_w3/cases.exs. Regenerate with `mise run corpus:emit`;
# never edit by hand.
#
# The document in this test is transformed for the predicator datamodel from
# 550/test550.txml of the W3C SCXML Implementation Report Plan test suite
...
defmodule SCXMLTest.Data.Test550 do
  ...
  test "test550" do
    ...
    <scxml xmlns="http://www.w3.org/2005/07/scxml" initial="s0" version="1.0" datamodel="predicator" binding="early">
        <state id="s0">
