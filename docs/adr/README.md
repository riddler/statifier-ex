...
| [0052](0052-durable-timers-consume-the-effect-vocabulary.md) | Durable timers consume the effect vocabulary; the host owns keying and the 6.2 discard | accepted (amended 2026-08-19: decisions 2, 3, and 4 corrected; decision 2's recorded gap decided by 0053) |
| [0053](0053-non-self-delayed-send-routes-stay-the-librarys.md) | Non-self delayed-send routes stay the library's: `#_parent`/`#_invokeid`/`#_internal` permanently, the external-session route deferred with a named trigger; no route field joins `%SendDelayed{}` | accepted (decides 0052's recorded gap) |
